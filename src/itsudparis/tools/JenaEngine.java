...
public class JenaEngine {
     ...
     *
     * @param inputDataFile + Entree: le chemin vers le fichier owl
...
// TODO Auto-generated catch block
     ...
     * Faire l'inference
     *
     * @param model + Entree: l'objet model Jena avec le chemin du fichier des regles
...
// TODO Auto-generated catch block
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public String executeQueryFileWithParameter(Model model, String
...
//add new value
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public boolean updateValueOfObjectProperty(Model model, String
            namespace, String object1Name, String propertyName, String object2Name) {
...
//add new value
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public boolean addValueOfObjectProperty(Model model, String
            namespace, String instance1Name, String propertyName, String
                                                           instance2Name) {
...
//add new value
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public boolean addValueOfDataTypeProperty(Model model, String
            namespace, String instanceName, String propertyName, Object value) {
        Resource rs = model.getResource(namespace + instanceName);
        Property p = model.getProperty(namespace + propertyName);
        if ((rs != null) && (p != null)) {
//add new value
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public boolean removeAllValuesOfProperty(Model model, String
            namespace, String objectName, String propertyName) {
